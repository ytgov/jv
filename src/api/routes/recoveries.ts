...
formRouter.get("/:recid", ReturnValidationErrors, async function (req: Request, res: Response) {
  try {
...
formRouter.post("/", ReturnValidationErrors, async function (req: Request, res: Response) {
  try {
...
formRouter.put("/:recid", ReturnValidationErrors, async function (req: Request, res: Response) {
  try {
    await db.transaction(async (trx) => {
      let items = req.body.items;
      delete req.body.items;
