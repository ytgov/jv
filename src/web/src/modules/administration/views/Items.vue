<template>
  <v-container>
    ...
    <div class="mt-2">
      <v-row class="mx-1">
        <v-btn class="my-4 ml-auto" color="primary" @click="addItem()">
          <div>Add Item</div>
    ...
    <v-dialog v-model="itemDialog" persistent max-width="800px">
      <v-card>
        ...
        <v-card-text>
          ...
          <v-checkbox label="Can Change Quantity" v-model="changeQuantity" />
          ...
          <v-text-field label="Default Cost" v-model="price" class="mt-1" outlined prefix="$" />

          <v-text-field label="Default Description" v-model="description" class="mt-1" outlined />
