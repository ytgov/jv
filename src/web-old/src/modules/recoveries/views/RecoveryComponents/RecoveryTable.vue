  ...
  <div class="mt-5 mx-10 mb-5">
        ...
        <v-row>
          <div>
            <v-btn
              ...
              color="warning"
              fab
              @click="deleteRecoveryClick(item)"
    ...
    >
      <v-card>
        ...
        <v-card-text>
          <div class="my-5 text-h6">Are you sure you would like to delete this Recovery?</div>
        </v-card-text>

        <v-card-actions>
          <v-btn
            color="grey darken-5"
            @click="deleteRecoveryDialog = false"
          >
            Cancel
          </v-btn>
          <v-btn
